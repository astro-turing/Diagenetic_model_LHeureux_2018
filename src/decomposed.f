...
!  Main code
       program marl_PDE
           ...
           COMMON/par/P
           ! ~\~ end
           ! ~\~ begin <<lit/index.md|main-open-output-files>>[init]
           OPEN(8,file='amarlt1')
           OPEN(9,FILE='amarlt2')
           ...
           t=0.0
           ! ~\~ end
           ! ~\~ begin <<lit/index.md|main-write>>[init]
           ...
           ! ~\~ begin <<lit/index.md|time-integration>>[init]
           ...
           do j=1,tmax
               ! ~\~ begin <<lit/index.md|log-progress>>[init]
